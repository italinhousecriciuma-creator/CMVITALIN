...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const [row] = await sql`INSERT INTO vendas (mes, ano, cardapio, grupos, itens_combo, total_qtd, total_fat, total_custo) VALUES (${mes}, ${ano}, ${cardapio}, ${JSON.stringify(grupos)}, ${JSON.stringify(itens_combo || [])}, ${total_qtd || 0}, ${total_fat || 0}, ${total_custo || 0}) RETURNING *`;
